...
describe('Relative Date Range Functions', () => {
    ...
    describe('calculateRelativeDates', () => {
        it('should return null for custom range', () => {
            expect(calculateRelativeDates('custom')).toBeNull();
        });
        
        it('should return null for unknown range', () => {
            expect(calculateRelativeDates('unknown')).toBeNull();
        });
        
        it('should calculate last 7 days', () => {
            const result = calculateRelativeDates('7d');
        ...
        it('should calculate last 30 days', () => {
            const result = calculateRelativeDates('30d');
            const expectedStart = new Date();
        ...
        it('should calculate last 3 months', () => {
            const result = calculateRelativeDates('3m');
            const expectedStart = new Date();
        ...
        it('should calculate last 6 months', () => {
            const result = calculateRelativeDates('6m');
            const expectedStart = new Date();
        ...
        it('should calculate last 12 months', () => {
            const result = calculateRelativeDates('12m');
            const expectedStart = new Date();
        ...
        it('should calculate last year', () => {
            const result = calculateRelativeDates('1y');
            const expectedStart = new Date();
        ...
        it('should calculate year to date', () => {
            const result = calculateRelativeDates('ytd');
            const expectedStart = new Date(today.getFullYear(), 0, 1);
    ...
    describe('applyDateRange', () => {
        ...
        it('should apply 7 day range to date inputs', () => {
            const mockStartDate = { value: '' };
            const mockEndDate = { value: '' };
            
            global.document.getElementById = vi.fn((id) => {
                if (id === 'start-date') return mockStartDate;
                if (id === 'end-date') return mockEndDate;
                return { value: '' };
            });
            
            applyDateRange('7d');
            
            expect(mockStartDate.value).not.toBe('');
            expect(mockEndDate.value).not.toBe('');
            
            const start = new Date(mockStartDate.value);
            const end = new Date(mockEndDate.value);
            const diffDays = (end - start) / (1000 * 60 * 60 * 24);
            
            expect(diffDays).toBeCloseTo(7, 0);
        });
        
        it('should apply 6 month range to date inputs', () => {
            const mockStartDate = { value: '' };
            const mockEndDate = { value: '' };
